...
function my_awesome_scripts()
{
    ...
    //TODO: check condition whether home page or not
    wp_enqueue_style('home-style-css', get_stylesheet_directory_uri() . '/assets/home.css', array(), filemtime(get_stylesheet_directory() . '/assets/home.css'));

    if (is_page_template('thank-you.php')) {
        wp_enqueue_style('thankYou-page-style', get_template_directory_uri() . '/assets/thank-you.css');
    }
}
